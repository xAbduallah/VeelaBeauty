...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const baseStyles =
      "items-center justify-center gap-2 font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed";

    const variantStyles = {
      primary: "bg-[#333333] text-white hover:bg-gray-800 active:bg-gray-900",
      secondary:
